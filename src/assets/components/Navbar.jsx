  ...
  return (
    <div className="Navbar w-screen h-[4rem] flex items-center justify-between absolute z-20">
      ...
      <div className="pr-[2rem]">
        ...
        <button className="border border-[#db0000]  text-white bg-[#db0000] font-semibold rounded-full p-[0.3rem] mr-[1rem] ml-[0.5rem] w-[6rem] hover:scale-110 duration-100"
      ...
      {/* <div className="px-3 mx-3 space-x-3">
        ...
        <button
        type="button" cLassName="px-4 py-2 bg-red-600 text-white rounded-3xl hover:bg-red-700"
